...
namespace MudEngine2012
{
    ...
    internal class Verb
    {
        internal ScriptFunction Matcher;
        internal ScriptFunction Action;
    }
                        ...
                        if (verbs.ContainsKey(firstWord))
                        {
                            ...
                            foreach (var verb in verbs[firstWord])
                            {
                                try
                                {
                                    ...
                                    matches = verb.Matcher.Invoke(matchContext, PendingCommand.Executor, arguments) as List<Object>;
                                }
                                catch (ScriptError e)
                                {
                                    continue;
